...
#'
#' @param audio_path A string with the path to an audio file or a folder
#'   containing audio files. If a folder is provided, the function will process
#'   all audio files in the folder. See `perform_speech_to_text` for more
#'   details.
