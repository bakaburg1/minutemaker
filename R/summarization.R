...
#' @param ... Additional arguments passed to the `llmR::prompt_llm` function,
...
#' @param ... Additional arguments passed to `llmR::prompt_llm` function, such
#'   as the LLM provider.
#'
...
#' @param prompt_only If TRUE, only the prompt is returned, the LLM is not
#'   interrogated. Default is FALSE.
#' @param ... Additional arguments passed to the `llmR::prompt_llm`
#'   function.
#'
