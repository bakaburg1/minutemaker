...
- **Transcript Import & Diarization Robustness**: Improved speaker extraction for VTT/MS Teams files, merging logic, and diarization handling to avoid index and silent segment issues. (Commits: [44bac1f](https://github.com/bakaburg1/minutemaker/commit/44bac1f), [65519a3](https://github.com/bakaburg1/minutemaker/commit/65519a3))
- **Agenda & Time Validation Hardening**: Strengthened agenda/time validation and NA handling in utilities to prevent malformed inputs from progressing. (Commits: [42a87b8](https://github.com/bakaburg1/minutemaker/commit/42a87b8), [50ba892](https://github.com/bakaburg1/minutemaker/commit/50ba892))
- **Summarization Stability**: Resolved prompt defaults and workflow ordering issues that could trigger errors when summarizing without prompts set. (Commit: [81236e1](https://github.com/bakaburg1/minutemaker/commit/81236e1))
- **Correction Resilience**: Added retry/error guards around LLM correction calls to reduce transient failures. (Commit: [972a1c7](https://github.com/bakaburg1/minutemaker/commit/972a1c7))
...
This release delivers a full LLM-based transcript correction pipeline, more resilient audio processing with new Parakeet MLX support, richer workflow/summarization controls, and broad new tests and documentation, while tightening validation and dependencies.
